...
#			apply_impulse(Vector3(initial_torque*transform.basis.z.x, initial_torque*transform.basis.z.y, initial_torque*transform.basis.z.z), Vector3(0,  0.375, 0))
#		elif "Half Log" in name:
		apply_impulse(Vector3(-initial_torque*transform.basis.x.x, -initial_torque*transform.basis.x.y, -initial_torque*transform.basis.x.z), Vector3(0, 0.375, 0))
