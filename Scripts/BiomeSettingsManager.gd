...
func _init():
	...
	self.default_biome_settings = BiomeSettings.new(default_height_map, Vector2(5.0, 15.0), 8.0)
	...
	self.foothills_biome_settings = BiomeSettings.new(foothills_height_map, Vector2(15.0, 45.0), 11.0)
	...
	self.mountain_biome_settings = BiomeSettings.new(mountain_height_map, Vector2(55.0, 75.0), 15.0)
	pass
